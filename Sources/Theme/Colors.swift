...
//  MdEditor
//
//  Created by Александр Николаев on 23.09.2024.
//
...
enum Colors {
    ...
    static let gray = UIColor.color(light: FlatColor.Gray.IronGray, dark: FlatColor.Gray.AlmondFrost)
}

enum Theme {
    static let mainColor = Colors.dark
    static let accentColor = Colors.violet
    static let backgroundColor = Colors.light

    static let chartCompleted = Colors.green
    static let chartUncompleted = Colors.red

    static let white = Colors.white
    static let black = Colors.black
    static let gray = Colors.gray
}
